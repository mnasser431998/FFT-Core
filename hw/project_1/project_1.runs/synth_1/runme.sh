...
HD_PWD='E:/work/vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bfu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bfu.tcl
