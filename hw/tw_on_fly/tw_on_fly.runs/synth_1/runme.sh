...
HD_PWD='E:/work/vivado/tw_on_fly/tw_on_fly.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tw_calc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tw_calc.tcl
